...
- What is known as the bystander effect? `r mcq(c(answer = "Often, individuals help less when there are many other potential helpers around",  "Bystanders intervened in 90% of observed public conflicts", "Competing priorities - such as being in a hurry - reduce the likelihood of helping"))` (Note that all statements are true.)
...
`r video_code("3JGV4u9kHcg")`

Before you move on, take a moment to reflect on the content of the video and answer the following questions:

- What is homophily? `r mcq(c("A preference for same-sex partners",  "The tendency to marry in-group members", answer = "The tendency to prefer friends and potential partners who are similar to oneself"))`
- Which of the following might explain why we like music better when we have heard it before? `r mcq(c("Reciprocity",  answer = "Mere exposure", "Personal preferences"))`

### Beauty - Myths & Debates

`r video_code("MnHqJquC_3w")`
...
- What are the key elements of love, according to Sternberg's triangular theory? `r mcq(c("Liking, Exposure, Similarity",  answer = "Intimacy, Passion, Commitment", "Values, Trust, Empathy"))`
